...
This study explores ethnography through the digital trail coupled with an account of the qualitative experience of individuals. Anthropology places value on the individual experience while providing structures for cross-context comparison, rather than methods in other fields that often aggregate to the point of significant information loss.
...
I have been an open source community contributor for much of my career and therefore deeply embedded in the social structure. However, as a white-hispanic female with a non-tradtional tech background, I represent a minority perspective and have spent much of my career understanding how to adapt to this culture. As an undergraduate, I majored in Anthropology before concentrating on computer science. I have a dual BA/BS and my focus was specifically on Linguistic Anthropology, but as part of my Anthropology requirement I took courses in all of the four subfields, including capstone coursework on anthropological theory and ethnography. I struggled with my career as a software engineer until I started getting involved with open source projects. 
...
Ethnography and Anthropology are uniquely suited to this situation because rather than seek to stamp out the personal bias (as if such a thing were possible), they provide methods that leverage it. Other than my initial training at the undergradute level, I do not have as much experience with applying these methods. In addition, due to the challenges present in engaging with open source communities for analysis for non-technical contributors, I am unique as a subject matter expert in that my initial training was in Anthropology. Anthropologists and Ethnographers have a lot to teach leaders in open source communities and I hope this work serves as a step in that direction.
